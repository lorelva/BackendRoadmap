...
//Echo Framework: Se utiliza para construir un servidor web en Go de manera eficiente y fácil.

// Echo Framework: Se elige Echo por su simplicidad, rendimiento y características como manejo de rutas,
// middleware, y manejo de errores integrados.

// ServerEcho *echo.Echo: Esta es una instancia del servidor Echo.
// Echo es elegido aquí porque es ligero, rápido y fácil de usar para construir APIs RESTful en Go.
